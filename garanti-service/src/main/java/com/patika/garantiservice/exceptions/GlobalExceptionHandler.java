...
import com.patika.garantiservice.exceptions.dto.ExceptionResponse;
import com.patika.garantiservice.exceptions.dto.KafkaLog;
...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ExceptionResponse> handleAllException(Exception exception) {
        ...
        kafkaTemplate.send("patika.logs", new KafkaLog("exception-garanti-service", ExceptionUtils.getFullStackTrace(exception) ));
